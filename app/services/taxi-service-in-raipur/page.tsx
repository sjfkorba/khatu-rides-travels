...
export const metadata = {
  title:
    "Taxi Service in Raipur | Best Cab Booking in Raipur | Khatu Rides Travels",
  description:
    "Book reliable taxi service in Raipur for airport transfer, railway station pickup, one way taxi, round trip cab booking and outstation travel across Chhattisgarh.",
  keywords: [
      ...
      <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 md:py-32">
          <span className="inline-flex items-center gap-2 rounded-full bg-orange-500/20 px-4 py-2 text-sm font-bold text-orange-300">
            <Star size={16} />
            Trusted Taxi Service in Raipur
          </span>

          <h1 className="mt-6 text-5xl font-black md:text-6xl">
            Best Taxi Service in Raipur
          </h1>

          <p className="mt-6 max-w-3xl text-xl leading-8 text-white/80">
            Khatu Rides Travels provides reliable taxi service in Raipur
            for airport transfer, railway station pickup, one way taxi,
  ...
  Call Now
      ...
      <section className="mx-auto max-w-7xl px-4 py-16">
        <div className="grid gap-5 md:grid-cols-4">
          <Feature
            icon={<Plane size={28} />}
            title="Airport Taxi"
            text="Raipur Airport pickup & drop service."
          />

          <Feature
            icon={<Car size={28} />}
            title="Outstation Taxi"
            text="One way & round trip bookings."
          />

          <Feature
            icon={<Building2 size={28} />}
            title="Corporate Travel"
            text="Business & official travel solutions."
          />
      ...
      <section className="mx-auto max-w-6xl px-4 py-8">
        <h2 className="text-4xl font-black">
          Cab Booking Service in Raipur
        </h2>

        <div className="mt-6 space-y-6 text-slate-700 leading-8">
          <p>
            Khatu Rides Travels offers comfortable and affordable
            taxi service in Raipur for airport transfer,
            railway station pickup, local city rides,
            family trips and corporate travel.
          </p>

          <p>
            We regularly provide cab service between Raipur,
            Korba, Bilaspur, Raigarh, Bhilai, Durg,
            Jagdalpur and Ambikapur.
          </p>

          <p>
            Whether you need a one way taxi,
            round trip cab, airport taxi or
            outstation vehicle booking,
        ...
        <div className="mx-auto max-w-5xl px-4">
          ...
          <div className="mt-8 space-y-8">
            <Faq
              ...
              a="Yes, airport pickup and drop service is available 24×7."
            />

            <Faq
              q="Can I book one way taxi from Raipur?"
              a="Yes, one way and round trip taxi booking both are available."
            />

            <Faq
              q="Do you provide outstation cab service?"
              a="Yes, Korba, Bilaspur, Raigarh, Jagdalpur and Ambikapur routes are available."
            />
          </div>
        </div>
      </section>
      ...
      <section className="bg-orange-600 py-20 text-white">
        <div className="mx-auto max-w-4xl px-4 text-center">
          ...
          <p className="mt-4 text-lg text-white/90">
            Contact Khatu Rides Travels for instant cab booking.
          </p>
