...
// 👑 BASTAR TOURISM & ECONOMIC CORRIDOR MICRO-ROUTES GRID
const MICRO_ROUTES = [
  { from: "Jagdalpur City Core", to: "Swami Vivekananda Airport Raipur (RPR)", dist: "295 KMs", tag: "Capital Link: Airport Drop" },
  { from: "Jagdalpur Railway Station (JDB)", to: "Durg / Bhilai Steel Belt", dist: "310 KMs", tag: "Industrial Link" },
  { from: "Chitrakoot Entrance, Jagdalpur", to: "Bilaspur Junction / Sakri", dist: "390 KMs", tag: "Long-Haul Corridor" },
  { from: "Kanger Valley Gate", to: "Transport Nagar, Korba", dist: "410 KMs", tag: "Mining Feeder Track" },
  { from: "Geedam Bypass Loop", to: "Dantewada Maa Danteshwari Temple", dist: "80 KMs", tag: "Bastar Nodes: Spiritual Tour" },
  { from: "Jagdalpur Bus Stand", to: "Kanker Keshkal Valley Hub", dist: "160 KMs", tag: "Highway Midpoint Link" },
  { from: "Bodhiwall Area, Jagdalpur", to: "Sukma Core Terminal", dist: "110 KMs", tag: "South Bastar Loop" },
  { from: "Jagdalpur Outskirts Ring Rd", to: "Kondagaon Handicraft Belt", dist: "75 KMs", tag: "Feeder Block Drop" },
  { from: "Tirathgarh Circuit Gate", to: "Raigarh Industrial Yards", dist: "430 KMs", tag: "Cross-District Express" },
  { from: "Bastar Palace Precinct", to: "Bhadrachalam Border (Telangana)", dist: "190 KMs", tag: "Interstate Link Corridor" }
];

export default function TaxiServiceInJagdalpurPage() {
...
I would like to book a premium outstation cab loop from Jagdalpur/Bastar region. The route configurations are listed below:
...
Please schedule this vehicle loop at your early convenience. Thank you!`;

    const cleanFormattedUrl = `https://wa.me/919244137353?text=${encodeURIComponent(textPayload)}`;
    window.open(cleanFormattedUrl, "_blank");
  };

  const jagdalpurSchema = {
    "@context": "https://schema.org",
    "@type": "Product",
    "name": "Khatu Rides Jagdalpur Bastar Taxi Operator",
    "image": "https://www.khaturidescg.in/dezire.png",
    "description": "Premium outstation car rentals, Bastar eco-tourism family packages, and secure oneway taxi transfers from Jagdalpur to Raipur Airport.",
    "brand": {
      "@type": "Brand",
      "name": "Khatu Rides Travels Co."
    },
  ...
  return (
    <main className="bg-slate-950 text-slate-100 min-h-screen">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify(jagdalpurSchema) }}
      />
      ...
      <section className="relative overflow-hidden bg-slate-950 border-b border-slate-900 pb-12">
        <div className="absolute inset-0 w-full h-full scale-105 opacity-10 blur-xs pointer-events-none">
          <img src="/banner6.png" alt="Bastar Division Map Guide" className="w-full h-full object-cover" />
        </div>
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 pt-16 md:pt-24 text-center">
          <span className="inline-flex items-center gap-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 px-4 py-2 text-xs font-black uppercase tracking-widest text-emerald-400">
            ...
            Official Bastar Tourism Fleet Partner
          </span>

          <h1 className="mt-6 text-4xl font-black tracking-tight sm:text-6xl text-white">
            Premium Taxi Service in Jagdalpur
          </h1>

          <p className="mt-4 max-w-3xl mx-auto text-base sm:text-lg leading-relaxed text-slate-400">
            Reliable, secure highway transit across the Kanker-Keshkal valley corridor. Book verified one-way and roundtrip cabs from Jagdalpur to Raipur Airport, Dantewada, and local waterfall circuits.
          </p>
        </div>
        ...
        <div className="relative z-20 mx-auto max-w-5xl px-4 mt-10">
          <div className="rounded-3xl border border-white/5 bg-white/[0.02] backdrop-blur-xl p-4 sm:p-6 shadow-2xl shadow-black/50">
            <h3 className="text-sm font-black text-center text-orange-500 uppercase tracking-widest mb-4">
              Calculate Real-Time Jagdalpur Outstation Slabs
            </h3>
            <FareCalculator 
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-4 py-16">
        <header className="text-center mb-10">
          ...
          <h2 className="text-3xl font-black tracking-tight text-white">
            Professional Bastar Travel Framework
          </h2>
        </header>
        ...
        <div className="grid gap-6 md:grid-cols-4">
          <Feature
            icon={<Plane size={28} />}
            title="Airport Linkages"
            text="High-reliability drops connecting Jagdalpur center directly to Swami Vivekananda Airport Raipur."
          />
          <Feature
            icon={<Car size={28} />}
            title="Bastar Tour Packages"
            text="Spacious MUV/SUV units fully optimized for multi-day tours around Chitrakoot and Tirathgarh."
          />
          <Feature
            icon={<Building2 size={28} />}
            title="One-Way Slabs"
            text="Pay strictly for the drop. Economical one-way outstation cab packages to Durg, Bhilai & Bilaspur."
          />
          <Feature
            icon={<Phone size={28} />}
            title="24/7 Route Assistance"
            text="Continuous real-time dispatch tracking and live security updates across long highway loops."
          />
        </div>
      </section>
      ...
      <section className="bg-slate-900/40 py-16 border-y border-slate-900">
        <div className="mx-auto max-w-7xl px-4">
          <header className="text-center mb-12">
            ...
            <h2 className="text-3xl font-black tracking-tight text-white">
              Choose Your Jagdalpur Vehicle Class
            </h2>
          </header>
              ...
              >
                <div>
                  ...
                  <div className="relative h-40 w-full flex items-center justify-center rounded-2xl bg-slate-950/50 border border-white/[0.02] my-4 overflow-hidden">
                    <img
                      src={vehicle.image}
                      alt={`${vehicle.name} - Khatu Rides Jagdalpur`}
      ...
      {/* 🧭 HYPER-LOCAL BASTAR HIGHWAY DIRECTORY */}
      <section className="mx-auto max-w-7xl px-4 py-16">
        <header className="mb-10 text-center md:text-left">
          <span className="text-[10px] font-black uppercase tracking-widest text-orange-500 block mb-1">
            Bastar Division Corridors
          </span>
          <h2 className="text-3xl font-black tracking-tight text-white">
            Geographic Regional Corridor Matrix
          </h2>
          <p className="text-slate-400 text-xs mt-1">
            Distance-locked outstation tracks bypassing Keshkal ghat loops flawlessly to align southern districts with industrial sectors.
          </p>
        </header>
            ...
            >
              <div className="space-y-1 max-w-[70%]">
                ...
                <p className="text-[10px] text-slate-500">
                  Pre-fixed flat fare layout including all applicable regional state taxes, tolls, and allowance guidelines.
                </p>
              </div>
      ...
      {/* 🏙️ COVERAGE GRID AREAS */}
      <section className="bg-slate-900/40 py-16 border-t border-slate-900">
        <div className="mx-auto max-w-7xl px-4">
          <header className="text-center mb-10">
            <span className="text-[10px] font-black uppercase tracking-widest text-orange-500 block mb-1">
              Bastar Presence Mapping
            </span>
            <h2 className="text-3xl font-black tracking-tight text-white">
              Areas We Serve Across Jagdalpur Circuits
            </h2>
          </header>

          <div className="grid gap-4 grid-cols-2 md:grid-cols-5">
            {[
              "Jagdalpur Bus Stand Hub",
              "Railway Station Area",
              "Chitrakoot Falls Circuit",
              "Tirathgarh Gate Entrance",
              "Geedam Junction Bypass",
              "Kondagaon Craft Sector",
              "Kanker Valley Corridor",
              "Keshkal Ghat Section",
              "Bodhiwall Residential",
              "Bastar Palace Precinct",
            ].map((area) => (
              <div
                key={area}
      ...
      <section className="mx-auto max-w-7xl px-4 py-16">
        <h2 className="text-3xl font-black tracking-tight text-white text-center mb-10">
          Why Choose Khatu Rides Travels in Jagdalpur?
        </h2>

        <div className="grid gap-4 md:grid-cols-2">
          {[
            "Highly Secure Fleet Routing past the Keshkal Valley Corridor",
            "Meticulously Cleaned and AC Optimized Passenger Vehicles",
            "Completely Transparent Upfront Rates with Zero Peak Hour Surges",
            "Custom Flexible Slabs for Regional Bastar Sightseeing Tours",
            "Guaranteed On-Time Airport Drops to Sync with Raipur Flights",
            "24/7 Continuous Communication Lines with Central Dispatch Desks",
          ].map((item) => (
            <div
              key={item}
      ...
      <section className="bg-slate-900/40 py-16 border-t border-slate-900">
        <div className="mx-auto max-w-5xl px-4">
          ...
          <div className="space-y-6">
            <Faq
              q="Do you provide family sightseeing car rentals for Chitrakoot and Tirathgarh?"
              a="Yes, Khatu Rides provides premium, high-clearance MUV Ertigas and luxury Innova Crystas perfectly mapped for multi-day tourism loops across Bastar waterfalls."
            />
            <Faq
              q="Can I book a flat-rate one-way sedan cab from Jagdalpur to Raipur Airport?"
              a="Absolutely. We specialized in providing distance-locked one-way outstation cabs via NH-30, saving commuters from standard two-way roundtrip overhead charges."
            />
            <Faq
              q="Are your drivers fully accustomed to the valley roads of Keshkal?"
              a="Yes, all our route-allocated chauffeurs are highly vetted regional experts with heavy year-round experience navigating the sharp curves and valley gradients of Keshkal ghats safely."
            />
          </div>
        </div>
      </section>
